...
public interface ISysUserService extends IService<SysUser>
{
     ...
     * @param ro
     */
    SysUser updateInfo(SysUserRO ro);

    IPage<SysUserVO> pageByCondition(SysUserPageRO ro);

    void updateUserDeptIds(Long userId, Long deptId);

    SysUserVO detail(Long userId);

    void light(String coordinate);

    List<LightMapVO> lightUserList();
