...
import com.alumni.common.exception.user.*;
...
import com.alumni.framework.manager.AsyncManager;
import com.alumni.framework.manager.factory.AsyncFactory;
import com.alumni.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService {
    ...
    public String wechatLogin(WechatLoginBody loginBody) {
        try {
            WechatAuthenticationToken authenticationToken =
                    new WechatAuthenticationToken(loginBody);
            ...
            AsyncManager.me().execute(
                    AsyncFactory.recordLogininfor(
                            loginBody.getNickName() + "_" + loginBody.getOpenId(),
    ...
    public String mobileLogin(MobileLoginBody loginBody) {
        try {
            WechatAuthenticationToken authenticationToken =
                    new WechatAuthenticationToken(loginBody);
