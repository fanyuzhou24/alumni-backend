...
public class SysRoleController extends BaseController {
    ...
    @PostMapping("/list/v2")
    @ApiOperation(value = "角色信息列表（不分页）", notes = "角色信息列表（不分页）")
    public AjaxResult listByCondition(@RequestBody SysRolePageRO ro) {
        List<SysRole> list = roleService.listByCondition(ro);
