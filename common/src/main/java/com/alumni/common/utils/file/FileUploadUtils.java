...
import com.alumni.common.exception.file.FileNameLengthLimitExceededException;
import com.alumni.common.exception.file.FileSizeLimitExceededException;
import com.alumni.common.exception.file.InvalidExtensionException;
...
import com.alumni.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AlumniConfig.getProfile();
    ...
    {
        int dirLastIndex = AlumniConfig.getProfile().length() + 1;
