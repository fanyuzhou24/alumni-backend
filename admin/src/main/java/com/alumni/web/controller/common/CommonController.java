...
import com.alumni.common.utils.file.FileUploadUtils;
import com.alumni.common.utils.file.FileUtils;
import com.alumni.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = AlumniConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = AlumniConfig.getUploadPath();
            // 上传并返回新文件名称
     ...
     */
    @PostMapping("/uploads")
    @ApiOperation(value = "上传文件（多个）", notes = "上传文件（多个）")
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = AlumniConfig.getProfile();
            // 数据库资源地址
