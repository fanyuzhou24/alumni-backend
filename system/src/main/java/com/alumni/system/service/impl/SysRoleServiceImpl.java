...
import com.alumni.system.entity.ro.SysRolePageRO;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService
{
    ...
    @Override
    public List<SysRole> listByCondition(SysRolePageRO ro) {
        return lambdaQuery()
                .eq(SysRole::getStatus, "0")
                .ne(SysRole::getRoleKey, "admin")
                .like(StringUtils.isNotBlank(ro.getRoleName()), SysRole::getRoleName, ro.getRoleName())
                .list();
    }
}
