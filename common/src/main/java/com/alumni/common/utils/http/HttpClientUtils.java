package com.alumni.common.utils.http;
...
public class HttpClientUtils {
    public static String doGet(String url, Map<String, String> param) {
        ...
        try {
            ...
            //超时设置
            RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(1000) //连接超时
        ...
        try {
            ...
            if (response != null) {
                try {
                    ...
                    throw new ServiceException("连接关闭异常！");
                }
            }
        }
